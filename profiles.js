...
function getSampleProfileData() {
  return {
    ...
    fullName: 'MD. ABDUR RAHIM',
    nameBn: 'মোঃ আব্দুর রহিম',
    fatherName: 'MD. ABDUL KARIM',
    fatherBn: 'মোঃ আব্দুল করিম',
    ...
    bloodGroup: 'B+',
    nidType: 'NID',
    nidNo: '19961234567890123',
    birthRegNo: '',
    passportNo: '',
    mobile: '01700000000',
    mobileConfirm: '01700000000',
    email: 'applicant.sample@example.com',
    quota: 'Not Applicable',
    quotaDetails: '',
    depStatus: 'Not Applicable',
    presentCareOf: 'MD. ABDUL KARIM',
    presentAddress: 'House 12, Road 4, Sector 1',
    presentDistrict: '1',
    presentUpazila: '1',
    presentPost: 'Uttara',
    presentPostcode: '1230',
    permanentCareOf: 'MD. ABDUL KARIM',
    permanentAddress: 'House 12, Road 4, Sector 1',
    permanentDistrict: '1',
    permanentUpazila: '1',
    permanentPost: 'Uttara',
    ...
    hscYear: '2014',
    graExam: 'Honors',
    graInstitute: 'University of Dhaka',
    graSubject: 'Computer Science',
    ...
    masYear: '',
    masDuration: '',
    bachelor: 'B.Sc (Honors) in Computer Science, University of Dhaka, 2018, CGPA 3.50',
    master: '',
    experienceComputer: 'Yes',
    experienceSatlipi: 'No',
    customFields: [
...
function groupWordsIntoRows(words) {
  ...
  // e.g. "Gender : : Male" or "Applicant's Name A MD. ABDUR RAHIM".
